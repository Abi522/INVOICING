...
from .views import InvoiceListCreateView, InvoiceRetrieveUpdateDestroyView, \
    InvoiceDetailListCreateView, InvoiceDetailRetrieveUpdateDestroyView
...
urlpatterns = [
    ...
    path('invoice-details/<int:pk>/', InvoiceDetailRetrieveUpdateDestroyView.as_view(),
         name='invoice-detail-retrieve-update-destroy'),
]
